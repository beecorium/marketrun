...
export default function JourneyMap({open,onOpenChange}:{open:boolean;onOpenChange:(v:boolean)=>void}){
 ...
 <div style={{width:`${zoom*100}%`,minWidth:'100%'}} className="g-map-art"><svg viewBox="180 65 1350 850" role="img" aria-label="망루에서 한내시장 쉼터로 내려온 뒤 포목거리를 지나 마실카페 앞 보부상 조형물로 이동하는 경로"><defs><marker id="gold-route-arrow" viewBox="0 0 10 10" refX="7" refY="5" markerWidth="3" markerHeight="3" orient="auto-start-reverse"><path d="M 0 0 L 10 5 L 0 10 z" fill="#007b78"/></marker></defs><image href="/images/market-run-map.png" x="0" y="0" width="2048" height="1032"/>
 {/* SVG paints in document order: routes, numbered markers, then opaque place labels. */}
 <g className="g-map-routes" fill="none" strokeLinecap="round" strokeLinejoin="round" pointerEvents="none">
 <path d="M1390 188 Q1230 440 997 763 M937 791 Q810 750 688 655 Q721 575 552 516 M482 480 Q406 450 355 414" stroke="white" strokeWidth="16"/>
 <g stroke="#007b78" strokeWidth="7" strokeDasharray="16 12"><path d="M1390 188 Q1230 440 997 763" markerEnd="url(#gold-route-arrow)"/><path d="M937 791 Q810 750 688 655 Q721 575 552 516" markerEnd="url(#gold-route-arrow)"/><path d="M482 480 Q406 450 355 414" markerEnd="url(#gold-route-arrow)"/></g></g>
