...
export default function Golden(){
 ...
 return <main className={`golden ${step===0?'golden-intro':'golden-mission'}`}>
  {step===0?<img className="g-main-banner" src="/images/golden-main-banner.png" alt="황금 패랭이를 찾아라 – 보령 꿀잼야행"/>:<><header><img src="/images/market-run-logo.png" alt="마켓런"/><span>황금 패랭이를 찾아라</span><button className="icon-btn" aria-label="여정 안내" onClick={()=>D(true)}><MapPin/></button></header>
  <div className="g-heading"><span className="g-eyebrow">밤길에 숨은 세 개의 징표</span></div></>}
